...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  $nama_gambar = htmlspecialchars(trim($_POST['nama_gambar']));
  $target_dir = "uploads/struktur_organisasi/";
  ...
  // Cek ukuran file (opsional, disini maksimal 500KB)
  ...
  if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
    $_SESSION['error_message'] = "Maaf, hanya file JPG, JPEG, & PNG yang diperbolehkan.";
    $uploadOk = 0;
  }
  ...
  if ($uploadOk == 1) {
    if (move_uploaded_file($_FILES["gambar"]["tmp_name"], $target_file)) {
      ...
      $stmt = $conn->prepare("INSERT INTO struktur_organisasi (nama_gambar, path_gambar) VALUES (?, ?)");
      $stmt->bind_param("ss", $nama_gambar, $target_file); // Simpan path lengkap
      ...
      $_SESSION['error_message'] = "Maaf, terjadi kesalahan saat mengupload file Anda.";
    }
  }
}

// Mengambil data dari database
$sql = "SELECT id, nama_gambar, path_gambar FROM struktur_organisasi";
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" name="nama_gambar" class="form-control" placeholder="Isi Nama Gambar" required>
              </div>
              <div class="form-group">
