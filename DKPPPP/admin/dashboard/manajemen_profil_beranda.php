...
// Ambil data profil beranda
$sql = "SELECT * FROM profil_beranda ORDER BY id DESC";
            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Profil Beranda</h3>
                    </div>
                    <div class="card-body">
                        <a href="profil_beranda_add.php" class="btn btn-primary mb-3">Tambah Isi</a>
                                ...
                                <?php if ($result->num_rows > 0): ?>
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="profil_beranda_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                                <a href="profil_beranda_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus ini?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
