...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Query untuk menyimpan data ke tabel profil_beranda
    $sql = "INSERT INTO profil_beranda (judul, deskripsi, tipe) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('sss', $judul, $deskripsi, $tipe);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil disimpan'); window.location.href='manajemen_profil_beranda.php';</script>";
    } else {
