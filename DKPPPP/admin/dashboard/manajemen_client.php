        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="client_add.php" class="btn btn-primary mb-3">Tambah Client</a>
                                ...
                                <?php if ($result->num_rows > 0): ?>
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td><img src="../uploads/clients/<?= htmlspecialchars($row['logo_image_url']) ?>" width="100"></td>
                                            <td>
                                                <a href="client_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                                <a href="client_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus ini?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
