...
$sql = "SELECT * FROM visi_misi order by id desc";
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Manajemen Visi Misi</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section class="content">
        <div class="card">
          ...
          <div class="card-body">
            <a href="visi_misi_add.php" class="btn btn-primary mb-3">Tambah Visi Misi</a>
                ...
                <?php if ($result->num_rows > 0): ?>
                  <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                      ...
                      <td><?= htmlspecialchars_decode(preg_replace('/<p><br><\/p>/', '', $row['judul'])) ?></td>
                      <td><?= htmlspecialchars_decode(preg_replace('/<p><br><\/p>/', '', $row['deskripsi'])) ?></td>
                      <td><?= htmlspecialchars($row['kategori']) ?></td>
                      <td>
                        <a href="visi_misi_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="visi_misi_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                      </td>
                    </tr>
                  <?php endwhile; ?>
                <?php else: ?>
