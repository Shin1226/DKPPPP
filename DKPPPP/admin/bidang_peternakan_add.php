...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO bidang_peternakan (judul, deskripsi) VALUES ('$judul', '$deskripsi')";
...
$sql = "SELECT id, judul, deskripsi FROM bidang_peternakan";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Bidang Peternakan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Bidang Peternakan</li>
                            </ol>
                        </div>
                    </div>
                </div>
