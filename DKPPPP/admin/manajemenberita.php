    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="card">
          ...
          <div class="card-body">
            <a href="news_add.php" class="btn btn-primary mb-3">Tambah Berita</a>
                ...
                <?php while ($row = $result->fetch_assoc()) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="news_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus berita ini?')">Hapus</a>
                    </td>
                  </tr>
                <?php endwhile; ?>
              </tbody>
