...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO bidang_ketahanan_pangan (judul, deskripsi) VALUES ('$judul', '$deskripsi')";
...
$sql = "SELECT id, judul, deskripsi FROM bidang_ketahanan_pangan";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Bidang Ketahanan Pangan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Bidang Ketahanan Pangan</li>
                            </ol>
                        </div>
                    </div>
                </div>
