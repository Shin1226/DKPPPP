            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Footer Data</h3>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered">
                            <tbody>
                                <?php if ($footer): ?>
                                    <!-- Loop untuk setiap data footer -->
                                    <?php foreach (['alamat' => 'map-marker-alt', 'telepon' => 'phone', 'email' => 'envelope', 'twitter' => 'twitter', 'youtube' => 'youtube', 'instagram' => 'instagram', 'facebook' => 'facebook', 'google_map' => 'map'] as $field => $icon): ?>
                                        <tr>
                                            <td>
                                                <div class="p-3 border rounded bg-light footer-item">
                                                    <strong><i class="fas fa-<?php echo $icon; ?>"></i> <?php echo ucfirst($field); ?>:</strong>
                                                    <div class="mt-2">
                                                        <?php if ($field === 'google_map'): ?>
                                                            <a href="<?php echo $footer[$field]; ?>" target="_blank" class="shortened-link">
                                                                <?php echo $footer[$field]; ?>
                                                            </a>
                                                        <?php else: ?>
                                                            <?php echo $footer[$field]; ?>
                                                        <?php endif; ?>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group" role="group">
                                                    <a href="footer_edit.php?id=<?php echo $footer['id']; ?>&field=<?php echo $field; ?>" class="btn btn-warning btn-sm">Edit</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group" role="group">
                                                <a href="footer_edit.php?id=<?php echo $footer['id']; ?>&field=copyright" class="btn btn-warning btn-sm">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php else: ?>
                                    <tr>
                                        <td colspan="2" class="text-center">No footer data available.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
