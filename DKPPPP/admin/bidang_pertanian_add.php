...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO bidang_pertanian (judul, deskripsi) VALUES ('$judul', '$deskripsi')";
...
$sql = "SELECT id, judul, deskripsi FROM bidang_pertanian";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Bidang Pertanian</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Bidang Pertanian</li>
                            </ol>
                        </div>
                    </div>
                </div>
