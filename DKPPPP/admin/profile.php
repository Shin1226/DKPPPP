...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "UPDATE users SET username='$username', email='$email', nama_lengkap='$nama_lengkap', password='$password' WHERE id='$id'";
  if ($conn->query($sql) === TRUE) {
    // echo "Profil berhasil diperbarui.";
    echo "<script>alert('Profil berhasil diperbarui, anda telah keluar.');window.location='login.php';</script>";
    session_destroy();
  } else {
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item"><a href="pengumuman.php" class="nav-link"><i class="far fa-circle nav-icon"></i>
                    <p>Pengumuman</p>
                  </a></li>
              </ul>
            </li>
