        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="pegawai_add.php" class="btn btn-primary mb-3">Tambah Pegawai</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($row['foto'])): ?>
                                                    <img src="uploads/pegawai/<?= htmlspecialchars($row['foto']) ?>" alt="<?= htmlspecialchars($row['nama']) ?>" width="100">
                                                <?php else: ?>
                                                    Tidak ada foto
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <a href="pegawai_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                                <a href="pegawai_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus kepala dinas ini?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
