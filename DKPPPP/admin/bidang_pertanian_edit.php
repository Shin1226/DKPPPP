...
$id = $_GET['id'];
$sql = "SELECT * FROM bidang_pertanian WHERE id='$id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "UPDATE bidang_pertanian SET judul='$judul', deskripsi='$deskripsi' WHERE id='$id'";
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Manajemen Bidang Pertanian</h1>
            </div>
            <div class="col-sm-6">
