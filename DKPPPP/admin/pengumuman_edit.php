...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($_FILES['file']['name']) {
    ...
    $target = "uploads/pengumuman/" . basename($file);
    move_uploaded_file($_FILES['file']['tmp_name'], $target);
  } else {
    $file = $data['file'];
  }

  $sql = "UPDATE pengumuman SET judul='$judul', deskripsi='$deskripsi', link='$link', file='$file' WHERE id='$id'";
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="link" class="form-control" value="<?= htmlspecialchars($data['link']) ?>">
              </div>
