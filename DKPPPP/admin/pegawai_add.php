...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $target_dir = "uploads/pegawai/";
    $target_file = $target_dir . basename($_FILES["foto"]["name"]);

    if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
        // Simpan data ke database
        $sql = "INSERT INTO pegawai (nama, nip, jabatan, instansi, foto) VALUES ('$nama', '$nip', '$jabatan', '$instansi', '$foto')";
...
$sql = "SELECT id, nama, nip, jabatan, instansi, foto FROM pegawai";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>NIP</label>
                                <input type="text" name="nip" class="form-control" placeholder="Isi NIP" required>
                            </div>
                            <div class="form-group">
                                <label>Jabatan</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="instansi" class="form-control" placeholder="Isi Instansi" required>
                            </div>
                            <div class="form-group">
                                <label>Foto</label>
