    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="card">
          ...
          <div class="card-body">
            <a href="pengumuman_add.php" class="btn btn-primary mb-3">Tambah Pengumuman</a>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php if (!empty($row['file'])): ?>
                          <a href="uploads/pengumuman/<?= htmlspecialchars($row['file']) ?>" target="_blank">Lihat File</a>
                        <?php else: ?>
                          Tidak ada file
                        <?php endif; ?>
                      </td>
                      <td>
                        <a href="pengumuman_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="pengumuman_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus pengumuman ini?');">Hapus</a>
                      </td>
                    </tr>
                  <?php endwhile; ?>
                <?php else: ?>
