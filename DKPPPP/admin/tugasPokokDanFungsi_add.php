...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO tugas_pokok_fungsi (tipe, judul, deskripsi) VALUES ('$tipe', '$judul', '$deskripsi')";
...
$sql = "SELECT id, judul, deskripsi, tipe FROM tugas_pokok_fungsi";
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Tambah Tugas & Fungsi</h3>
          </div>
          <div class="card-body">
