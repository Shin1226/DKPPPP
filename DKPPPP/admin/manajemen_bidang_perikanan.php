...
$sql = "SELECT * FROM bidang_perikanan ORDER BY id DESC";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Manajemen Bidang Perikanan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Manajemen Bidang Perikanan</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Bidang Perikanan</h3>
                    </div>
                    <div class="card-body">
                        <a href="bidang_perikanan_add.php" class="btn btn-primary mb-3">Tambah Isi</a>
                                ...
                                <?php if ($result->num_rows > 0): ?>
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td><?= $row['deskripsi'] ?></td>
                                            <td>
                                                <a href="bidang_perikanan_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                                <a href="bidang_perikanan_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus ini?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
