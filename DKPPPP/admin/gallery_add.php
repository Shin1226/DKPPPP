...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO gallery (kategori, judul, gambar, jenis_media, link_video) VALUES ('$kategori', '$judul', '$gambar', '$jenis_media', '$link_video')";
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Judul</label>
                <input type="text" name="judul" class="form-control" placeholder="Isi Text" required>
              </div>
              <div class="form-group">
