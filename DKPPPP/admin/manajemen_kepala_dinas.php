...
$sql = "SELECT * FROM kepala_dinas order by id desc";
      ...
      <section class="content">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Data Kepala Dinas</h3>
          </div>
          <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if (!empty($row['foto'])): ?>
                          <img src="uploads/kepala_dinas/<?= htmlspecialchars($row['foto']) ?>" alt="<?= htmlspecialchars($row['nama']) ?>" width="100">
                        <?php else: ?>
                          Tidak ada foto
                        <?php endif; ?>
                      </td>
                      <td>
                        <a href="kepala_dinas_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="kepala_dinas_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus kepala dinas ini?');">Hapus</a>
                      </td>
                    </tr>
                  <?php endwhile; ?>
                <?php else: ?>
