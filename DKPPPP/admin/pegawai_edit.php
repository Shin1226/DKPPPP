...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($foto) {
        $target = "uploads/pegawai/" . basename($foto);
    ...
    $sql_update = "UPDATE pegawai SET nama = ?, nip = ?, jabatan = ?, instansi = ?, foto = ? WHERE id = ?";
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <img src="uploads/pegawai/<?= htmlspecialchars($data['foto']) ?>" width="100" alt="Foto Kepala Dinas" style="margin-top: 10px;">
